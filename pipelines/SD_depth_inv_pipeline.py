...
class StableDiffusionDepth2ImgInvPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        if not return_depth:
            ...
            return ImagePipelineOutput(images=image), depth_mask, latents_list
