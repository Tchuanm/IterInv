...
with open('prompt_all_imgs.txt', 'r') as file:
    ...
    for line in file:
        ...
        old_path = f'/disk1/users/kwang-local/ctang/deepfloyd/output/all_imgs_inversion_in_prompt_file/{bname}/CFG1_3.0_CFG3_1.0_noise3_100_lr1_0.001_scale3_0.3_NPI_False/{prompt}/'
        ...
        if not os.path.exists(source_path):
            continue
        new_path = f'/disk1/users/kwang-local/ctang/deepfloyd/output/stage2_inv/stage123_a_object_scale_{scale2}/'
